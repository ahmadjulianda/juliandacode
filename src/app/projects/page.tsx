...
const projects: Project[] = [
    ...
    {
        id: 'amaral-company-profile',
        title: 'Company Profile',
        description: 'A Company Profile with Beutiful UI and user friendly, make it easy to navigate and informative.',
        image: '/projects/amaral-2.jpg',
        tags: ['Next.js', 'Javascript', 'Tailwind CSS'],
        category: 'Frontend',
        liveUrl: 'https://amaraldwinajaya.vercel.app/',
        githubUrl: 'https://github.com/amaraldwinajaya/amaraldwinajaya',
    },
    {
        id: 'website-yayasan',
        title: 'Company Profile',
